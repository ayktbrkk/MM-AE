...
- Son P5 polish gecisinde Ankara/Sakarya/Final setup hedefleri tek cumlelik eylem metnine indirildi; bu zone'larda guidance metin etiketi yerine yalnizca ok/halo birakildi ve location sign katmani HUD altinda tekrar gorunmeyecek sekilde kontrata baglandi.
- Final `Cumhuriyet Notu` anchor'i discovery cluster ve companion reaction spot ile birlikte HUD-guvenli oyun bandina cekildi; yenilenen `artifacts/renders/final/final_world_p5_probe.png` capture'inda ust ekran tekrar/baslik kirpilmasi kapandi.
