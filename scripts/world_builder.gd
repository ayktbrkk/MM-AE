...
# Room builder referansı — decompose edilmiş room zone inşa kodu
const _RoomBuilder := preload("res://scripts/world_builders/room_builder.gd")
...
func build_world(area_key: String, world_root: Node) -> void:
	...
	match area_key:
		"room":
			var room_builder := _RoomBuilder.new()
			room_builder.build_room(world_root, self)
		"ship":
